...
\item Built Frontend/Svelte components with GraphQL backend enabling contextual search across petabyte scale video data.
...
\item Authored golib-consul, a platform library interfacing Consul for config management and service discovery.
