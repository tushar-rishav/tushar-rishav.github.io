...
\item Built full-stack application showcasing contextual search across petabyte scale video data using Svelte, Go, GraphQL, MySQL, and multi-modal vector embeddings.
...
\item Carried out cost optimization for cloud resources, achieving 30\% reduction in monthly costs.
